...
class Selector extends \Less\Tree{
    ...
    function createDerived( $elements, $extendList = null, $evaldCondition = null ){
        ...
        $newSelector = new \Less\Tree\Selector( $elements, ($extendList ? $extendList : $this->extendList), $this->condition, $this->index, $this->currentFileInfo, $this->isReferenced);
    ...
    function genCSS( $env, &$strs ){
        ...
        if( !\Less\Environment::$firstSelector && $this->elements[0]->combinator->value === "" ){
